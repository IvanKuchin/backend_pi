...
CStatistics::~CStatistics()
{
	...
	MESSAGE_INFO ("", "", "time duration (in ticks) = " + to_string((float)(endClock - startClock) /  CLOCKS_PER_SEC));
	MESSAGE_INFO ("", "", "chrono duration = " + to_string(endChrono.count() - startChrono.count()) + " microseconds");
